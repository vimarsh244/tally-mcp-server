...
export function registerOAuthRoutes(app: express.Express, store: AuthStore, publicDir: string): void {
...
function handleRefresh(req: express.Request, res: express.Response, store: AuthStore, clientId: string) {
...
function respondWithTokens(res: express.Response, store: AuthStore, clientId: string) {
