...
import { cachedTableWith, columns, fail, guard, isoDate, ok, readOnly, targetCompany } from './shared.mjs';
...
export const voucherTools = ({ server, cache }) => {
    server.registerTool('daybook', {
        ...
        return cachedTableWith(cache, columns(['guid', 'string'], ['date', 'date'], ['voucher_type', 'string'], ['voucher_number', 'string'], ['reference', 'string'], ['party_name', 'string'], ['amount', 'number'], ['narration', 'string'], ['is_cancelled', 'boolean'], ['is_optional', 'boolean']), page, {
