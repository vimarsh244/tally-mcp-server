...
export const statementTools = ({ server, cache }) => {
    server.registerTool('chart-of-accounts', {
        ...
        return cachedTable(cache, columns(['ledger_name', 'string'], ['group_name', 'string'], ['primary_group', 'string'], ['bs_pl', 'boolean'], ['dr_cr', 'boolean'], ['affects_gross_profit', 'boolean'], ['sort_position', 'number']), rows);
    }));
    server.registerTool('trial-balance', {
        ...
        return cachedTable(cache, columns(['ledger_name', 'string'], ['group_name', 'string'], ['opening_balance', 'amount'], ['net_debit', 'amount'], ['net_credit', 'amount'], ['closing_balance', 'amount']), rows);
    }));
